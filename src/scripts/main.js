...
document.querySelector("#adult-plus").addEventListener("click", () => {
  adults++;
  updateGuests();
});
document.querySelector("#adult-minus").addEventListener("click", () => {
  if (adults > 0) adults--;
  updateGuests();
});
document.querySelector("#child-plus").addEventListener("click", () => {
  children++;
  updateGuests();
});
document.querySelector("#child-minus").addEventListener("click", () => {
...
function renderStays(items) {
  ...
  titleEl.textContent = selectedCity
...
function handleSearch() {
  ...
  document.querySelector("#display-location").textContent = selectedCity
